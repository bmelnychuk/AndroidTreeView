 ...
 */
class ArrowExpandSelectableHeaderHolder(context: Context) : TreeNode.BaseNodeViewHolder<IconTreeItemHolder.IconTreeItem>(context) {
    ...
    override fun createNodeView(node: TreeNode, value: IconTreeItemHolder.IconTreeItem): View? {
        ...
        arrowView!!.setOnClickListener { treeView!!.toggleNode(node) }
